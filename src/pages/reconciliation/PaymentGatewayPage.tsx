...
export function PaymentGatewayPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Payment Gateway Reconciliation</h1>
        <p className="text-gray-500 dark:text-gray-400 mt-1">Reconcile payment gateway transactions (Stripe, PayPal, PayMongo, GCash, Maya)</p>
      </div>
