    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Stay informed about reconciliation events</p>
        </div>
            ...
            {notifications.map((notif) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className={`text-sm ${notif.is_read ? 'text-gray-700' : 'text-gray-900 font-medium'}`}>{notif.title}</p>
